...
limitations = [
    ...
    'Confounding Variables: Age, medication status, education level, and comorbidities were not fully controlled in the statistical analysis. Normal aging itself produces some alpha slowing (approximately 0.1 Hz per decade), and many AD patients take medications that may independently affect EEG patterns.',
